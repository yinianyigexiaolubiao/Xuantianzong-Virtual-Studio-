# 玄天宗 Master Project Registry — 2026-08-08

This is the **project-level archive index**. It is intentionally broader than the Canon/Digital-Twin registry.
...
1. **CANON_AND_WORLD** — world bible, maps, A/B/C/E/F/G technical controls.
2. **DIGITAL_TWIN** — Blender world-data, deterministic builders, V0.1 proof and V0.2 active milestone.
3. **VISUAL_ASSETS** — historical mother images, strategic maps, gate/hall/scene explorations.
4. **PROMO_FILM_AND_DJI** — promotional-film direction, real-DJI camera rules, shot/prompt workflow, 小云雀 integration history.
5. **PHONE_CONTENT** — disciple phone introductions, spirit-stone content and real-phone imaging rules.
6. **XUANYUAN_LIANQI** — 《玄元炼气诀》 text lineage, 214-page ancient-book PDF and page-image workflow.
7. **DIGITAL_XUANTIANZONG** — V0.1–V0.3 living-world/canon-engine lineage.
8. **BEASTS_AND_SACRED_TREES** — beast gate, F2/F3/G1 lineage and three sacred trees.
9. **HISTORICAL_ARCHIVE** — superseded canon versions, D1 and low-priority concept batches.
...
- `GITHUB_REGISTERED_METADATA` — project work is represented and classified in GitHub, but original bytes are not mirrored here.
...
The current world authority remains controlled by:

- `docs/canon/AUTHORITY_STACK_V1.6.1.md`
- `data/canon/source_registry_v1.6.1.json`
- `data/canon/post_canon_overrides.json`

Historical V1.0–V1.6 files and old images remain valuable provenance but do not override V1.6.1/current registered scoped locks.

## Recovered project timeline

### 2026-08-03 — 《玄元炼气诀》

Recovered a substantial standalone cultivation-manual branch: drafts, rewritten source text, vertical ancient-book PDFs, no-punctuation layout tests, a **214-page ancient-book PDF**, reference pages and two five-page generated-image batches.
...
Digital Xuantianzong V0.3 historically contained 67 structured canon clauses, 20 core entity cards and 5 approved revisions while preserving V0.1–V0.2 world time/events/permanent memory.

### 2026-08-05 — Visual mother-image lineage
...
Recovered V1.6 full locked lineage, `玄天宗视觉母图总览.png`, `玄岳仙宗全景设定图.png` (misnamed filename; Xuantianzong V1.6 content) and an annotated V1.6 overview image.
...
This census deliberately separates **100% project representation in GitHub** from **100% physical binary mirroring**.
...
The date sweep also returned unrelated account files (for example the 2026-08-07 AI-image daily-account batch and a Hogwarts classroom image). They are explicitly excluded from the 玄天宗 archive.
